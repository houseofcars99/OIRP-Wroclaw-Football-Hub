...
const initial: Token[] = [{ id: 1, number: 1, x: 50, y: 91, side: "ours" }, { id: 2, number: 4, x: 24, y: 74, side: "ours" }, { id: 3, number: 5, x: 76, y: 74, side: "ours" }, { id: 4, number: 8, x: 18, y: 54, side: "ours" }, { id: 5, number: 10, x: 50, y: 57, side: "ours" }, { id: 6, number: 7, x: 82, y: 54, side: "ours" }, { id: 7, number: 9, x: 50, y: 38, side: "ours" }, { id: 8, number: 1, x: 50, y: 8, side: "rival" }, { id: 9, number: 2, x: 24, y: 25, side: "rival" }, { id: 10, number: 3, x: 76, y: 25, side: "rival" }, { id: 11, number: 4, x: 18, y: 43, side: "rival" }, { id: 12, number: 5, x: 50, y: 40, side: "rival" }, { id: 13, number: 6, x: 82, y: 43, side: "rival" }, { id: 14, number: 7, x: 50, y: 61, side: "rival" }];
