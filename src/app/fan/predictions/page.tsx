...
import FanLiveFeed from "@/components/FanLiveFeed";
import "./live.css";
...
export default function PredictionsPage(){
 ...
 return <main className="lineupShell fanShell"><PageHeader eyebrow="STREFA KIBICA" title="Match Center"/>
  ...
  <nav className="fanNav"><button className="active">Typer</button><Link href="/fan/lineup">Skład</Link><a href="#relacja">Relacja</a><a href="#ranking">Ranking</a></nav>
