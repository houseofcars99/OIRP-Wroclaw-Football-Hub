...
export default function AdminPage() {
  ...
  return <AppShell>
    ...
    <Link className="captainTacticsShortcut" href="/captain/tactics"><span><b>TAKTYKA 7 × 7</b><small>Ustaw naszych zawodników, rywali, piłkę i schematy rozegrania</small></span><strong>OTWÓRZ →</strong></Link>
